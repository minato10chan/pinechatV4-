...
CATEGORY_KEYWORDS = {
    "物件概要": {
        "keywords": ["物件", "建物", "完成", "販売", "建築", "間取り", "設備", "価格", "契約"],
        "sub_categories": {
            "完成時期": ["完成", "竣工", "入居"],
            "販売開始": ["販売", "分譲", "募集"],
            "建築確認": ["建築", "確認", "申請"],
            "間取り・仕様": ["間取り", "LDK", "部屋数"],
            "設備・オプション": ["設備", "オプション", "仕様"],
            "デザイン・外観": ["デザイン", "外観", "外装"],
            "建築会社・デベロッパー": ["建築会社", "デベロッパー", "施工"],
            "価格・費用": ["価格", "費用", "コスト"],
            "資産価値・売却": ["資産価値", "売却", "投資"],
            "契約・手続き": ["契約", "手続き", "申込"]
        }
    ...
    "地域特性・街のプロフィール": {
        "keywords": ["地域", "街", "人口", "歴史", "地理", "自然", "イベント", "都市", "治安", "景観"],
        "sub_categories": {
            "概要・エリア区分": ["エリア", "地区", "地域"],
            "人口・居住特性": ["人口", "居住", "世帯"],
            "街の歴史・地域史": ["歴史", "由来", "発展"],
            "地理的特性": ["地理", "地形", "立地"],
            "自然環境": ["自然", "公園", "緑"],
            "地域イベント・伝統行事": ["イベント", "祭り", "行事"],
            "都市連携・姉妹都市情報": ["連携", "姉妹都市", "交流"],
            "治安・騒音・環境整備": ["治安", "騒音", "環境"],
            "風景・景観・街並み": ["景観", "風景", "街並み"],
            "観光・地元特産品・名産・グルメ": ["観光", "特産", "グルメ"]
        }
    }
} 